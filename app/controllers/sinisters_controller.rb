class SinistersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sinister.save
        format.html { redirect_to @sinister, flash: { success: 'Sinister was successfully created.' } } 
  ...
  private
    ...
    def sinister_params
      params.require(:sinister).permit(:client_id, :data, :date, :sinistro, :data_acidente, :seguradora, :valor, :comissao_percentual, :comissao, :data_recebimento, :valor_recebido, :status)
    end
end
